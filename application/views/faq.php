...
<head>
	...
	<link href="<?php echo base_url ('assets/css_ori/css_template/css/pages/faq.css')?>" rel="stylesheet" type="text/css">
				...
				<ul class="nav pull-right">
					<li class="dropdown">						
						...
						<ul class="dropdown-menu">
							<li><a href="https://www.facebook.com/aazizpriatna?fref=ts"  target="_blank">Abdul Aziz Priatna</a></li>
							<li><a href="https://about.me/misdan_wijaya" target="_blank">Misdan Wijaya</a></li>
						</ul>						
					</li>
				</ul>
	...
	<div class="footer-inner">
		...
		<div class="container">
			...
			<div class="row">
    			...
    			<div class="span12">
    				&copy; 2013 <a href="http://www.egrappler.com/">Good Job</a>.
    			</div> <!-- /span12 -->
...
<script src="<?php echo base_url ('assets/css_ori/css_template/js/base.js')?>"></script>
<script src="<?php echo base_url ('assets/css_ori/css_template/js/faq.js')?>"></script>
